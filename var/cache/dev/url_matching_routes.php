...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/api/findPoster' => [[['_route' => 'getPoster', '_controller' => 'App\\Controller\\TMDBController', '_format' => null, '_stateless' => true, '_api_resource_class' => 'App\\Entity\\Movie', '_api_operation_name' => 'getPoster'], null, ['GET' => 0], null, false, false, null]],
