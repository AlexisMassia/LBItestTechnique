 ...
 */
class getPeopleRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PeopleRepository.php';

        return $container->privates['App\\Repository\\PeopleRepository'] = new \App\Repository\PeopleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
