 ...
 */
class getMovieHasPeopleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MovieHasPeopleRepository' shared autowired service.
     *
     * @return \App\Repository\MovieHasPeopleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MovieHasPeopleRepository.php';

        return $container->privates['App\\Repository\\MovieHasPeopleRepository'] = new \App\Repository\MovieHasPeopleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
